...
Import-LocalizedData LocalizedData -FileName FMGlobal_Group.strings.psd1
...
function Set-TargetResource
{
    ...
    # Create an instance of PrincipalContext for the provided credential, or for Domain if crential
    # is not provided, but a Domain name is.
