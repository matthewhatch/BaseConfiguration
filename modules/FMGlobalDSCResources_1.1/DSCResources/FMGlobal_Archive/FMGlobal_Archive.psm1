...
$CacheLocation = "$env:systemroot\system32\Configuration\BuiltinProvCache\FMGlobal_Archive"
...
Function Compare-FileToEntry
{
    ...
    try
    {
		# JMP - 7/30/2014 - Corrected problem where a .DLL in the archive
		#                   was in use, so need to open the "Read" access
		#                   because constructor where FileAccess is not
		#                   specified defaults to "Read/Write" access.
        $existingStream = New-Object System.IO.FileStream $FileName, "Open", "Read"
